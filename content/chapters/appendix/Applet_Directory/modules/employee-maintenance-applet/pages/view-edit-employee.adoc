...
image::Employee_Edit-Payment-Config[Employee Edit Payment Config, align = "center"]
...
image::Employee_Edit-AccountManager[Employee Edit Account Manager, align = "center"]
