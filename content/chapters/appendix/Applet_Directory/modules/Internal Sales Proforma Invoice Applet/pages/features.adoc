...
image::InternalSalesProformaInvoiceApplet-ListingInternalSalesProformaInvoiceApplet-View-LineItems.png[InternalSalesProformaInvoiceApplet-View-LineItems, align = "center"]
