...
image::Merchant-EditMerchant-Tax&Billing-Tax&BillingListing.png[align="center"]

* Please click the ‘+’ button to add a tax to the merchant.

.Merchant - Edit Merchant - Tax & Billing - Tax & Billing Create
image::Merchant-EditMerchant-Tax&Billing-Tax&BillingCreate.png[align="center"]
...
image::Merchant-EditMerchant-Tax&Billing-Tax&BillingEdit.png[align="center"]
