...
image::9-ShippingPriceset-CreateShippingPriceset.png[Create Shipping Priceset, align = "center"]
...
image::10-ShippingPricesetListing-CreatedPriceset.png[Created Priceset, align = "center"]
