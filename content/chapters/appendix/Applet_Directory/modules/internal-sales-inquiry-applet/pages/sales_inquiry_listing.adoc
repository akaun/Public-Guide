...
image::InternalSalesInquiryApplet-Create-SelectLineItem-SearchItem-SelectLineItem-IssueLink-EditIssue-Planning.png[InternalSalesInquiryApplet-Create-SelectLineItem-SearchItem-SelectLineItem-IssueLink-EditIssue-Planning, align=center]
