...
image::CustomerEdit-CreditTerm.png[Credit Term, align = "center"]
...
image::CustomerEdit-CreditTerm-CreditTermCreate-NewCreditTerm.png[New Credit Term, align = "center"]

===== 4.2.11.1.2 Existing Credit Term

Users are only needed to select the existing credit term.

image::CustomerEdit-CreditTerm-CreditTermCreate-ExistingCreditTerm.png[Existing Credit Term, align = "center"]
...
image::CustomerEdit-CreditLimit.png[Credit Limit, align = "center"]
...
image::CustomerEdit-CreditLimit-CreditLimitCreate-NewCreditLimit.png[New Credit Limit, align = "center"]

===== 4.2.11.2.2 Existing Credit Limit

Users are only needed to select the existing credit limit.

image::CustomerEdit-CreditLimit-CreditLimitCreate-ExistingCreditLimit.png[Existing Credit Limit, align = "center"]
