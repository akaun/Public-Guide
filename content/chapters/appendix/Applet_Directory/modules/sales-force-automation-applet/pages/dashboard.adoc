...
image::dashboard-searcbar.png[Search Bar, align = "center"]
...
image::deals-contract-create.png[Create Contact, align = "center"]
...
image::deals-contract-add.png[Add Contact, align = "center"]
