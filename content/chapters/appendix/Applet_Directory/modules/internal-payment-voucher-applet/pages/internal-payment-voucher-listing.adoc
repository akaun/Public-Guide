...
image::CreatePaymentVoucher-Account-Payee-SelectBillingAddress.pnh[Billing Address, align = "center"]
...
image::CreatePaymentVoucher-Expenses-AddExpenses-AddItem.png[Add Item, align = "center"]
