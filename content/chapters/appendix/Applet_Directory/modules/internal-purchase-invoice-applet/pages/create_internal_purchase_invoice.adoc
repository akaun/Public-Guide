...
image::CreatePurchaseInvoice-Account-ShipTo-SelectBillingAddress.png[align="center"]
...
==== 1.1.3.3 A list of items will be displayed on the right side.
...
===== 1.1.3.4.2 n the Delivery Instruction Tab of Item Details Tab
