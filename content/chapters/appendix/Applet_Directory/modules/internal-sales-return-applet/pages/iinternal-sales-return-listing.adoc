...
image::CreateInternalSalesReturn-KOFor-DeliveryOrder[Delivery Order, align = "center"]

image::CreateInternalSalesReturn-KOFor-JobSheet[Job Sheet, align = "center"]

image::CreateInternalSalesReturn-KOFor-SalesInvoice[Sales Invoice, align = "center"]

image::CreateInternalSalesReturn-KOFor-SalesOrder[Sales Order, align = "center"]
