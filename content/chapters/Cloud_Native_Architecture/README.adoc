...
[#h2_cloud_native_integration]
==== Integrations 

spikes in loads

[#h2_cloud_native_infra_toolchain]
==== Infrastructure and Toolchain

Various tools ready to be used out of the box...
example : OCR, Lambda, RDS, NoSQL, API Gateway

[#h2_cloud_native_network_effect]
==== Network Effect

[#h2_cloud_native_cost_savings]
==== Cloud Cost Savings

[#h2_cloud_native_ai]
==== Artificial Intelligence

[#h2_cloud_native_human_resource]
==== Human Resource


[#h2_cloud_native_journey]
=== Journey


[#h2_cloud_native_challenges_lessons]
=== Challenges and Lessons 




[#h2_cloud_native_technical_considerations]
