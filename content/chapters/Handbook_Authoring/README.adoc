...
image::images/github_akaun_PublicGuide_download_code.png[] 
...
You may place the images anywhere in any sub-folders inside the "content/" folder, and reference to it in your asciidoc document using images/<image-file-name>. The *bin/publish.sh* would copy all images in the "content" folder into the "content/images" folder before the compilation and build of all asciidoctor formats.
